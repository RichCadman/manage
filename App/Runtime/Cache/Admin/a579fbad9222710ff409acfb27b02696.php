...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="current">增加项目时间</a> </div>
  <h1>增加项目时间</h1>
</div>
    ...
    <div class="span6">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="/admin.php/Item/item_add_time_do" method="post" class="form-horizontal" enctype="multipart/form-data" >
            ...
            <div class="control-group ">
              ...
              <div class="controls">
                <select name="user_id">
                  <option value="0">请选择</option>
                  <?php if(is_array($users)): foreach($users as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["username"]); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">时间 / 天</label>
              <div class="controls">
                <input type="number" class="span2" name="day" />
              </div>
            </div>
