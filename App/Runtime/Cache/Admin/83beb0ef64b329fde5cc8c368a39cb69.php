...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="tip-bottom">修改信息</a> <a href="#" class="current">修改信息</a> </div>
  <h1>修改信息</h1>
</div>
    ...
    <div class="span6">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="/admin.php/My/my_editor_do/id/<?php echo ($info["id"]); ?>" method="post" class="form-horizontal" enctype="multipart/form-data" >
            <div class="control-group">
              <label class="control-label">员工名称</label>
              <div class="controls">
                <input type="text" class="span3" name="username" disabled value="<?php echo ($info["username"]); ?>"/>
              </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
                <div  data-date="12-02-2012" class="input-append date datepicker">
                  <input type="text" name="birthday" value="<?php echo ($info["birthday"]); ?>"  data-date-format="yyyy-mm-dd" class="span11" >
