...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a><a href="#" class="tip-bottom">项目管理</a> <a href="#" class="current">待确认项目</a> </div>
    <h1 style="float:left">待确认项目</h1>
  </div>
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr class="gradeX">
                  ...
                  <?php if($v['is_result'] == 0): ?><td><button onclick="affirm(this,<?php echo ($v["id"]); ?>)" class='btn btn-success'>确认</button></td>
                  <?php else: ?>
...
<script type="text/javascript">
  // 帮点确认方法
  function affirm(obj,id){
    // 发送sql语句
    if(confirm("确定操作吗？")){
      $.post('/admin.php/Item/item_affirm_do',{id:id},function(data){
        // 判断是否成功
        if (data.statu==200) {
