...
<div id="content">
  <div id="content-header">
    ...
    <h1 style="float:left">员工总览</h1><a href="/admin.php/Users/users_add" class="btn btn-large btn-success" style="float:right;margin-top:30px;margin-right:15px">添加员工</a>
  </div>
              ...
              <tbody>
                <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr class="gradeX">
                  ...
                  <td width="300px;">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <?php if($v['name']=='admin'): ?><button onclick="del(this,<?php echo ($v["id"]); ?>)" class='btn btn-danger'>回收站</button>
                    <?php else: ?>
                    <button onclick="del(this,<?php echo ($v["id"]); ?>)" class='btn btn-danger'>回收站</button><?php endif; ?>
                  </td>
