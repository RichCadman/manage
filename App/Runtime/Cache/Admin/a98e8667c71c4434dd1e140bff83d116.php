...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="tip-bottom">请假</a> </div>
  <h1>请假</h1>
</div>
    ...
    <div class="span6">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="/admin.php/My/leave_do" method="post" class="form-horizontal" enctype="multipart/form-data" >
            <div class="control-group">
              <label class="control-label">原因</label>
              <div class="controls">
                <input type="text" class="span10" name="cause" />
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <div  data-date="12-02-2012" class="input-append date datepicker">
                  <input type="text" name="start_time"  data-date-format="yyyy-mm-dd" class="span11" >
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <div  data-date="12-02-2012" class="input-append date datepicker">
                  <input type="text" name="end_time"  data-date-format="yyyy-mm-dd" class="span11" >
                  <span class="add-on"><i class="icon-th"></i></span> </div>
              </div>
            </div>
            
            <div class="control-group">
              <label class="control-label">共 / 天</label>
              <div class="controls">
                <input type="number" class="span2" name="days" />
              </div>
            </div>
