...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> 菜单栏</a>
  <ul>
    ...
    <?php if($_SESSION['userinfo']['position_id'] == 1): ?><li class="submenu <?php echo ($current=='item'?'active':''); ?>"> <a href="#"><i class="icon icon-th-list"></i> <span>项目管理</span> <!-- <span class="label label-important">2</span> --></a>
      ...
      <li class="submenu <?php echo ($current=='work'?'active':''); ?>"> <a href="#"><i class="icon  icon-comments-alt"></i> <span>考勤管理</span> <!-- <span class="label label-important">2</span> --></a>
    ...
    <?php if($_SESSION['userinfo']['position_id'] != 1): ?><li class="<?php echo ($current=='leave'?'active':''); ?>"> <a href="/admin.php/My/leave.html"><i class="icon icon-user"></i> <span>请假条</span></a> </li>
...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a>  <a href="#" class="current">项目分配</a> </div>
  <h1>项目分配(<?php echo ($item["name"]); ?>--<?php echo ($item["durations"]); ?>天)</h1>
</div>
    ...
    <div class="span6">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="/admin.php/Item/allot_add_do" method="post" class="form-horizontal" enctype="multipart/form-data" >
            <!-- 项目id -->
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="number" class="span2" name="duration_ui" />
              </div>
            </div>
            <!-- 分界线 -->
            <div class="control-group ">
              <label class="control-label span6">前端</label>
              <div class="controls">
                <select name="user_id_web">
                  <option value="0">请选择</option>
                  <?php if(is_array($web)): foreach($web as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["username"]); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">项目工期 / 天</label>
              <div class="controls">
                <input type="number" class="span2" name="duration_web" />
              </div>
            </div>
            <!-- 分界线 -->
            <div class="control-group ">
              <label class="control-label span6">程序</label>
              <div class="controls">
                <select name="user_id_code">
                  <option value="0">请选择</option>
                  <?php if(is_array($code)): foreach($code as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["username"]); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">项目工期 / 天</label>
              <div class="controls">
                <input type="number" class="span2" name="duration_code" />
              </div>
            </div>
            <!-- 分界线 -->
