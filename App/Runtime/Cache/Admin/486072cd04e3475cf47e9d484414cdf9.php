...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="current">我的信息</a> </div>
    <h1 style="float:left">我的信息</h1>
  </div>
            ...
            <table class="table table-bordered data-table" style="overflow:hidden">
              ...
              <tbody>
                <tr class="gradeX">
                  ...
                  <?php if($info['sex']==0): ?><td>保密</td>
                  <?php elseif($info['sex']==1): ?>
                  <td>男</td>
                  <?php else: ?>
                  <td>女</td><?php endif; ?>
                  ...
                  <td width="150px;">
                    <a href="/admin.php/My/my_editor/id/<?php echo ($info["id"]); ?>"><button class='btn btn-primary' style="margin-left:10px">编辑</button></a>
