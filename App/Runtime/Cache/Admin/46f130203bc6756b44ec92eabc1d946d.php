    ...
    <div class="span6">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="/admin.php/Users/users_add_do" method="post" class="form-horizontal" enctype="multipart/form-data" >
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <div  data-date="12-02-2012" class="input-append date datepicker">
                  <input type="text" name="birthday"  data-date-format="yyyy-mm-dd" class="span11" >
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span3" maxlength="11" name="phone" onkeyup="if(!(/^1[34578]\d{9}$/.test(this.value)) && this.value.length==11){alert('格式错误')}" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">密码</label>
              <div class="controls">
                <input type="text" class="span6" name="password" placeholder="(6-12位组合密码)" />
              </div>
            </div>
            <div class="control-group ">
              ...
              <div class="controls">
                <select name="position_id">
                  ...
                  <?php if(is_array($position)): foreach($position as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
                <div  data-date="12-02-2012" class="input-append date datepicker">
                  <input type="text"  data-date-format="yyyy-mm-dd" name="entry_time" class="span11" >
                  <span class="add-on"><i class="icon-th"></i></span> </div>
              </div>
            </div>
