...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="current">推送项目</a> </div>
  <h1>推送项目</h1>
</div>
    ...
    <div class="span6">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="/admin.php/Remark/remark_web_push_do" method="post" class="form-horizontal" enctype="multipart/form-data" >
            <div class="control-group ">
              <label class="control-label span6">客户</label>
              <div class="controls">
                <select name="item_id">
                  <option value="0">请选择</option>
                  <?php if(is_array($items)): foreach($items as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>
            <div class="control-group ">
              ...
              <div class="controls">
                <select name="id">
                  <option value="0">请选择</option>
                  <?php if(is_array($projects)): foreach($projects as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["web_name"]); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>
