...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="current">添加修改记录</a> </div>
  <h1>添加修改记录</h1>
</div>
    ...
    <div class="span6">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="/admin.php/Remark/add_remark_do" method="post" class="form-horizontal" enctype="multipart/form-data" >
            <div class="control-group ">
              <label class="control-label span6">项目</label>
              <div class="controls">
                <select name="item_id">
                  <option value="0">请选择</option>
                  <?php if(is_array($info)): foreach($info as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>
            <div class="control-group ">
              <label class="control-label span6">客户</label>
              <div class="controls">
                <select name="openid">
                  <option value="0">请选择</option>
                  <?php if(is_array($customer)): foreach($customer as $key=>$v): ?><option value="<?php echo ($v["openid"]); ?>"><?php echo ($v["title"]); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>
            <div class="control-group">
            ...
            <div class="form-actions">
              <button type="submit" value="upload" name="submit" class="btn btn-success">上传</button>
              <button type="submit" value="upload_t" name="submit" class="btn btn-success">上传并推送</button>
            </div>
          </form>
        </div>
      </div>  
