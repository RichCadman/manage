...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="tip-bottom">修改员工</a> <a href="#" class="current">修改员工</a> </div>
  <h1>修改员工</h1>
</div>
    ...
    <div class="span6">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="/admin.php/Users/users_editor_do/id/<?php echo ($info["id"]); ?>" method="post" class="form-horizontal" enctype="multipart/form-data" >
            <div class="control-group">
              <label class="control-label">员工名称</label>
              <div class="controls">
                <input type="text" class="span3" name="username" value="<?php echo ($info["username"]); ?>"/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">手机号</label>
              <div class="controls">
                <input type="text" class="span3" maxlength="11" name="phone" onkeyup="if(!(/^1[34578]\d{9}$/.test(this.value)) && this.value.length==11){alert('格式错误')}"  value="<?php echo ($info["phone"]); ?>"/>
              </div>
            </div>
            
            <div class="control-group ">
              <label class="control-label span6">职位</label>
              <div class="controls">
                <select name="position_id">
                  <option value="0">请选择</option>
                  <?php if(is_array($position)): foreach($position as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"  <?php if(($v["id"]) == $info["position_id"]): ?>selected<?php endif; ?>><?php echo ($v["name"]); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
                <div  data-date="12-02-2012" class="input-append date datepicker">
                  <input type="text"  data-date-format="yyyy-mm-dd" name="entry_time" class="span11"  value="<?php echo ($info["entry_time"]); ?>"/>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span10" name="openid" value="<?php echo ($info["openid"]); ?>"/>
              </div>
            </div>
            <!-- <div class="control-group">
