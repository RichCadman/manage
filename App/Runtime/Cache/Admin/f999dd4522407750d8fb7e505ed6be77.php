...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="current">日志</a> </div>
    <h1 style="float:left">日志</h1>
  </div>
...
<script type="text/javascript">
  ...
  function del(obj,id){
    // 发送sql语句
    if(confirm("确定删除吗？")){
      $.post('/admin.php/Index/item_del',{id:id},function(data){
        // 判断是否成功
        if (data.statu==200) {
