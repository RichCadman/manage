...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="tip-bottom">员工管理</a><a href="#" class="current">回收站</a> </div>
    <h1 style="float:left">回收站</h1>
  </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            ...
            <table class="table table-bordered data-table" style="overflow:hidden">
              ...
              <tbody>
                <?php if($info): if(is_array($info)): foreach($info as $k=>$v): ?><tr class="gradeX">
                  <td><?php echo ($k+1); ?></td>
                  <td><?php echo ($v["username"]); ?></td>
                  <?php if($v['sex']==0): ?><td>保密</td>
                  <?php elseif($v['sex']==1): ?>
                  <td>男</td>
                  <?php else: ?>
                  <td>女</td><?php endif; ?>
                  ...
                  <td width="180px;">
                    <a href="/admin.php/Users/users_recycle_do/id/<?php echo ($v["id"]); ?>"><button class='btn btn-primary' style="margin-left:10px">恢复</button></a>
                  </td>
...
<script type="text/javascript">
  ...
  function del(obj,id){
    // 发送sql语句
    if(confirm("确定恢复吗？")){
      $.post('/admin.php/Index/users_del',{id:id},function(data){
        // 判断是否成功
        if (data.statu==200) {
