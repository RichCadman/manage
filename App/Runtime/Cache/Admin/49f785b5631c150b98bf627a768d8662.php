...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="current">项目关联客户</a> </div>
  <h1>项目关联客户</h1>
</div>
    ...
    <div class="span6">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="/admin.php/Item/item_link_do" method="post" class="form-horizontal" enctype="multipart/form-data" >
            <div class="control-group ">
              <label class="control-label span6">项目</label>
              <div class="controls">
                <select name="item_id">
                  <option value="0">请选择</option>
                  <?php if(is_array($item)): foreach($item as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>
            <div class="control-group ">
            ...
            <div class="form-actions">
              <button type="submit" class="btn btn-success">关联</button>
            </div>
          </form>
        </div>
      </div>  
