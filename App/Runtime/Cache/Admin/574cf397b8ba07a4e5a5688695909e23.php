...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="tip-bottom">上传项目</a> <a href="#" class="current">上传项目</a> </div>
  <h1>上传项目</h1>
</div>
    ...
    <div class="span6">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="/admin.php/Remark/remark_web_do" method="post" class="form-horizontal" enctype="multipart/form-data" >
            ...
            <div class="control-group">
              <label class="control-label">上传项目(<span style="color:red">zip格式压缩包</span>)</label>
              <div class="controls">
