...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a><a href="#" class="tip-bottom">项目管理</a> <a href="#" class="current">待客户确认</a> </div>
    <h1 style="float:left">待客户确认</h1>
  </div>
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr class="gradeX">
                  ...
                  <td><a href="/admin.php/Remark/help_hit/id/<?php echo ($v["id"]); ?>" class="btn btn-success">帮点确认</a></td>
