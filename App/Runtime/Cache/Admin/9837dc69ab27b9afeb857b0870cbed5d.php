...
<div id="content-header">
  <div id="breadcrumb"> <a href="work_index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="tip-bottom">上传考勤</a> </div>
  <h1>上传考勤</h1>
</div>
    ...
    <div class="span6">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="/admin.php/Work/upload_do" method="post" class="form-horizontal" enctype="multipart/form-data" >
            <div class="control-group">
              <label class="control-label">年-月</label>
              <div class="controls">
                <input type="text" class="span3" name="month" />
              </div>
            </div>
            
            <div class="control-group">
              <label class="control-label">上传考勤表</label>
              <div class="controls">
